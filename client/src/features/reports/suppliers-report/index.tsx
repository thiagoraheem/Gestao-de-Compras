          ...
          <>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Métricas chave para análise de desempenho do fornecedor no processo de cotação</CardDescription>
              </CardHeader>
              <CardContent>
                {isLoading ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="bg-card rounded-lg border border-border p-4 col-span-1 md:col-span-2 lg:col-span-3">
                      ...
                      <ChartContainer config={{ activity: { label: "Cotações" } }} className="w-full h-64">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Todas as cotações realizadas com o fornecedor selecionado</CardDescription>
              </CardHeader>
              <CardContent>
                {isLoading ? (
                  <div className="flex items-center justify-center py-6">
